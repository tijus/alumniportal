...
class ActionColumn extends Column
{
     ...
     * @see buttons
     */
    public $template = '{create-message}';
    /**
       ...
       // if (!isset($this->buttons['view'])) {
         //   $this->buttons['view'] = function ($url, $model, $key) {
           //     $options = array_merge([
            ...
            //};
        //}
        if (!isset($this->buttons['create-message'])) {
            $this->buttons['create-message'] = function ($url, $model, $key) {
                $options = array_merge([
                    'title' => Yii::t('yii', 'Write Discussion'),
                    'aria-label' => Yii::t('yii', 'Write Discussion'),
                    'data-pjax' => '0',
                ], $this->buttonOptions);
